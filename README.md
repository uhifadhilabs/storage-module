...
An unconfigured host already has a working, private, on-disk evidence store.
...
- [docs/files-hub.md](docs/files-hub.md) — the cross-module `/files` screens: what a host wires, the widgets, `FileSourceInterface`, and removal.

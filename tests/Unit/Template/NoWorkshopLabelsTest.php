 ...
 *
 * Every widget in the design files carries an identifier — TM·K1, PM·A, FL·05,
 ...
 * is not product. A person on the Files hub has no decisions table, cannot
 * follow the reference and reads "FL·K1Files kept" as a typo.
 *
 ...
 * instances somebody happened to notice: no template may emit a widget identifier,
...
final class NoWorkshopLabelsTest extends TestCase
{
    ...
    private const array FORBIDDEN = [
        ...
        'literal middot' => '/\b(?:TM|PM|DP|MB|AU|FL)\x{00B7}/u',
        'named entity' => '/\b(?:TM|PM|DP|MB|AU|FL)&middot;/',
        'numeric entity' => '/\b(?:TM|PM|DP|MB|AU|FL)&#(?:183|xB7);/i',
    ];
